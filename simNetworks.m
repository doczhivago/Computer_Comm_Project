...
% simNetworks
% Simulates and compares CEBCRA, DEBR, LEACH routing protocols for a given
...
%
% Change Log
% 7/1/13 Function definitions, node parameters
% 7/9/13 Added plotNetworks
% 7/13/13 Updated plotNetworks
...
%     %DEBR
%     if (round==1)
%     nDEBR=setupDEBR(nDEBR);
%     end
%     nDEBR=steadyStateDEBR(nDEBR);
%     if (nDEBR.numDeadNodes>nDEBR.numNodes-10)%&&(nDEBR.numDeadNodes==nDEBR.numNodes)&&(nLEACH.numDeadNodes==nLEACH.numNodes)
%         break; 
%     end
%      if (round==1000)||round==1100||round==1150||round==600||round==500; 
%         
%         d=2; %debugging
%     end
